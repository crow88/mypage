...
(lib.bg8 = function() {
	this.initialize(img.vote_group_shot_3_bg8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.bg9 = function() {
	this.initialize(img.vote_group_shot_3_bg9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.ch1 = function() {
	this.initialize(img.vote_group_shot_3_ch1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,768);


(lib.ch1_w = function() {
	this.initialize(img.vote_group_shot_3_ch1_w);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,768);


(lib.ch2 = function() {
	this.initialize(img.vote_group_shot_3_ch2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,768);


(lib.ch2_w = function() {
	this.initialize(img.vote_group_shot_3_ch2_w);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,768);


(lib.ch3 = function() {
	this.initialize(img.vote_group_shot_3_ch3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,768);


(lib.ch3_w = function() {
	this.initialize(img.vote_group_shot_3_ch3_w);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,768);


(lib.ch_all = function() {
	this.initialize(img.vote_group_shot_3_ch_all);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,640);


(lib.ch_all_blur = function() {
	this.initialize(img.vote_group_shot_3_ch_all_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,640);


(lib.font2_ = function() {
	this.initialize(img.vote_group_shot_3_font2_);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,431,139);


(lib.font2_w = function() {
	this.initialize(img.vote_group_shot_3_font2_w);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,431,139);


(lib.fp_kira = function() {
	this.initialize(img.vote_group_shot_3_fp_kira);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,20,20);


(lib.logo_voice = function() {
	this.initialize(img.vote_group_shot_3_logo_voice);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,400,314);


(lib.logo_white = function() {
	this.initialize(img.vote_group_shot_3_logo_white);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,400,314);// helper functions:
...
(lib.logo_white_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.logo_white_1, new cjs.Rectangle(19,-18,200,157), null);


(lib.font2_w_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.font2_w();
	this.instance.parent = this;
	this.instance.setTransform(-107.75,-34.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.font2_w_1, new cjs.Rectangle(-107.7,-34.7,215.5,69.5), null);
...
(lib.title = function(mode,startPosition,loop) {
	...
	// レイヤー_3
	this.instance = new lib.logo_voice();
	this.instance.parent = this;
	this.instance.setTransform(-100,-132,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.title, new cjs.Rectangle(-119,-132,252,157), null);
...
(lib.yusho_mc = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-0.0494,-20.3609);
	...
	// レイヤー_5
	this.instance_1 = new lib.font2_w_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-0.25,-17.25);
	this.instance_1.alpha = 0.0117;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(13).to({_off:false},0).to({alpha:0.3984},5,cjs.Ease.get(-1)).to({alpha:0.0117},5,cjs.Ease.get(1)).to({_off:true},1).wait(22));

	// font
	this.instance_2 = new lib.font2_();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-108,-52,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(46));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-108,-52,215.5,69.5);
...
}).prototype = getMCSymbolPrototype(lib.trofy_mc, new cjs.Rectangle(-101,-73,200,157), null);
...
(lib.chara_3_mc = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.0117},16,cjs.Ease.get(1)).wait(1).to({alpha:0.8008},4,cjs.Ease.quadIn).to({x:18.1,y:422.7,alpha:0.0117},5).to({_off:true},1).wait(1));

	// img
	this.instance_1 = new lib.chara_3();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,550.2,1,1,0,0,0,0,393);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(21).to({alpha:0.0117},5).to({_off:true},1).wait(1));
...
(lib.chara_2_mc = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.0117},16,cjs.Ease.get(1)).wait(1).to({alpha:0.8008},4,cjs.Ease.quadIn).to({x:-22.85,alpha:0.0117},5,cjs.Ease.get(1)).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({startPosition:0},16,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({startPosition:0},4,cjs.Ease.quadIn).to({alpha:0.0117},5,cjs.Ease.get(1)).to({_off:true},1).wait(1));
...
(lib.chara_1_mc = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.0117},12,cjs.Ease.get(1)).wait(1).to({alpha:0.8008},13,cjs.Ease.quadInOut).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({startPosition:0},12,cjs.Ease.get(1)).wait(1).to({startPosition:0},0).to({startPosition:0},13,cjs.Ease.quadInOut).to({_off:true},1).wait(1));
...
(lib.sprite44のコピー = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(71.6,-11.1,0.281,0.281);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-52.15,12.3,0.281,0.281);

	this.instance_2 = new lib.sprite43();
	this.instance_2.parent = this;
	this.instance_2.setTransform(109.65,-13.4,0.281,0.281);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(0.6,-40.5,0.281,0.281);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(-84.4,-11.1,0.281,0.281);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(80.2,-31.7,0.281,0.281);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(-60.2,-36.8,0.281,0.281);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(12.2,-13.4,0.281,0.281);
...
p.nominalBounds = new cjs.Rectangle(-86.9,-43,199.10000000000002,81);
...
(lib.award_txt_mc = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(4.65,6.1,0.9936,0.9936,0,0,0,17.4,0);
	...
	this.title1.setTransform(-4,13.5);

	this.timeline.addTween(cjs.Tween.get(this.title1).wait(1));

}).prototype = getMCSymbolPrototype(lib.award_txt_mc, new cjs.Rectangle(-112,-38.5,215.5,82.4), null);
...
// stage content:
(lib.vote_group_shot_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{group_1:22,group_2:36,group_3:98,skip:99});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(20).call(this.frame_20).wait(2).call(this.frame_22).wait(14).call(this.frame_36).wait(63).call(this.frame_99).wait(26).call(this.frame_125).wait(1).call(this.frame_126).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},127).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(125).to({_off:false},0).to({_off:true},2).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(117).to({_off:false},0).to({_off:true},10).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(31).to({_off:false},0).to({_off:true},12).wait(95));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_2).wait(99).to({_off:false},0).to({_off:true},1).wait(38));

	// white_title
	this.instance_1 = new lib.font2_w_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(115.75,120.6);
	this.instance_1.alpha = 0.6016;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(100).to({_off:false},0).wait(1).to({y:28.45},0).wait(2).to({y:289.25,alpha:0.1992},14,cjs.Ease.quadIn).to({y:278.5,alpha:0.0117},6,cjs.Ease.quadInOut).to({_off:true},1).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.sho).wait(99).to({_off:false},0).to({y:124.35,alpha:1},1).to({y:32.2},1,cjs.Ease.get(1)).to({y:30.5},2,cjs.Ease.get(1)).to({y:292.2},14,cjs.Ease.quadIn).to({y:282.25},6,cjs.Ease.quadInOut).to({y:283},3).to({_off:true},1).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_3).wait(99).to({_off:false},0).to({_off:true},1).wait(38));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]},101).to({state:[]},26).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(101).to({_off:false},0).to({_off:true},26).wait(11));

	// unit_mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_117 = new cjs.Graphics().p("AJAMLQgGgGAAgIQAAgIAGgGQAGgGAIAAQAJAAAFAGQAGAGAAAIQAAAIgGAGQgFAGgJAAQgIAAgGgGg");
	var mask_graphics_118 = new cjs.Graphics().p("AAONtQiKiMAAjMQAAjMCKiMQCMiMDMAAQDNAACLCMQCMCMAADMQAADMiMCMQiLCMjNAAQjMAAiMiMg");
	var mask_graphics_119 = new cjs.Graphics().p("AoiPPQkSkSAAmQQAAmPESkSQERkRGPAAQGRAAERERQESESAAGPQAAGQkSESQkRERmRABQmPgBkRkRg");
	var mask_graphics_120 = new cjs.Graphics().p("AvqQxQmYmYAApUQAApTGYmXQGXmYJTAAQJUAAGYGYQGXGXAAJTQAAJUmXGYQmYGXpUAAQpTAAmXmXg");
	var mask_graphics_121 = new cjs.Graphics().p("A00U1QoeodAAsYQAAsWIeoeQIeoeMWAAQMYAAIdIeQIeIeAAMWQAAMYoeIdQodIesYAAQsWAAoeoeg");
	var mask_graphics_122 = new cjs.Graphics().p("A5+Z/QqkqjAAvcQAAvaKkqkQKkqkPaAAQPcAAKjKkQKkKkAAPaQAAPcqkKjQqjKkvcAAQvaAAqkqkg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(117).to({graphics:mask_graphics_117,x:61.0243,y:78.4993}).wait(1).to({graphics:mask_graphics_118,x:84.2045,y:101.6745}).wait(1).to({graphics:mask_graphics_119,x:107.3846,y:124.8496}).wait(1).to({graphics:mask_graphics_120,x:120.0051,y:148.0247}).wait(1).to({graphics:mask_graphics_121,x:119.99,y:154.9}).wait(1).to({graphics:mask_graphics_122,x:119.975,y:154.875}).wait(1).to({graphics:null,x:0,y:0}).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(117).to({_off:false},0).to({_off:true},10).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(99).to({_off:false},0).to({alpha:0.3008},18,cjs.Ease.quadInOut).to({_off:true},8).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get(this.unit).wait(99).to({_off:false},0).wait(18).to({_off:true},8).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_4).wait(32).to({_off:false},0).to({alpha:1},4,cjs.Ease.get(1)).to({_off:true},91).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_5).wait(32).to({_off:false},0).to({alpha:0.8008},4,cjs.Ease.get(1)).to({_off:true},91).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_6).wait(28).to({_off:false},0).to({scaleX:0.9294,scaleY:0.1722},2).wait(1).to({scaleX:0.7781,scaleY:0.1638},0).wait(1).to({scaleX:0.3474,scaleY:0.1398},0).wait(1).to({scaleX:0.2,scaleY:0.1316},0).to({_off:true},1).wait(104));

	// レイヤー_5
	this.instance_10 = new lib.logo_white_1();
	this.instance_10.parent = this;
	this.instance_10.setTransform(120,154,1,1,0,0,0,120,57);
	this.instance_10.alpha = 0.0117;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({alpha:0.8984},3,cjs.Ease.get(-1)).to({alpha:0.5},6,cjs.Ease.get(-1)).to({alpha:0.1992},2).wait(1).to({alpha:0.1016},0).wait(8).to({alpha:0.3984},0).to({alpha:0.6992},3,cjs.Ease.get(1)).to({regY:57.1,scaleX:0.773,scaleY:0.773,y:154.05,alpha:0.0117},7,cjs.Ease.get(-1)).to({_off:true},1).wait(107));
	...
	this.timeline.addTween(cjs.Tween.get(this.trf).to({alpha:1},3,cjs.Ease.get(-1)).wait(20).to({scaleX:0.7731,scaleY:0.7731,alpha:0.0117},7,cjs.Ease.get(-1)).to({_off:true},1).wait(107));

	// chara_3
	this.instance_11 = new lib.chara_3_mc("synched",0,false);
	this.instance_11.parent = this;
	this.instance_11.setTransform(120,254.6,0.4,0.4,0,0,0,0,393);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(34).to({_off:false},0).wait(1).to({regX:10.5,regY:404.1,scaleX:0.4754,scaleY:0.4754,x:130.65,y:256.15,startPosition:1},0).wait(1).to({scaleX:0.5382,scaleY:0.5382,x:136,y:253.75,startPosition:2},0).wait(1).to({scaleX:0.5918,scaleY:0.5918,x:140.55,y:251.75,startPosition:3},0).wait(1).to({scaleX:0.6385,scaleY:0.6385,x:144.55,y:250,startPosition:4},0).wait(1).to({scaleX:0.6799,scaleY:0.6799,x:148.1,y:248.45,startPosition:5},0).wait(1).to({scaleX:0.7172,scaleY:0.7172,x:151.3,y:247.05,startPosition:6},0).wait(1).to({scaleX:0.7513,scaleY:0.7513,x:154.2,y:245.75,startPosition:7},0).wait(1).to({scaleX:0.783,scaleY:0.783,x:156.9,y:244.55,startPosition:8},0).wait(1).to({scaleX:0.8129,scaleY:0.8129,x:159.5,y:243.4,startPosition:9},0).wait(1).to({scaleX:0.8417,scaleY:0.8417,x:161.95,y:242.3,startPosition:10},0).wait(1).to({scaleX:0.8698,scaleY:0.8698,x:164.35,y:241.25,startPosition:11},0).wait(1).to({scaleX:0.8977,scaleY:0.8977,x:166.75,y:240.2,startPosition:12},0).wait(1).to({scaleX:0.9259,scaleY:0.9259,x:169.1,y:239.1,startPosition:13},0).wait(1).to({scaleX:0.955,scaleY:0.955,x:171.65,y:238,startPosition:14},0).wait(1).to({scaleX:0.9853,scaleY:0.9853,x:174.25,y:236.85,startPosition:15},0).wait(1).to({scaleX:1.0176,scaleY:1.0176,x:177,y:235.65,startPosition:16},0).wait(1).to({scaleX:1.0523,scaleY:1.0523,x:179.95,y:234.35,startPosition:17},0).wait(1).to({scaleX:1.0903,scaleY:1.0903,x:183.2,y:232.9,startPosition:18},0).wait(1).to({scaleX:1.1324,scaleY:1.1324,x:186.8,y:231.3,startPosition:19},0).wait(1).to({scaleX:1.1798,scaleY:1.1798,x:190.85,y:229.5,startPosition:20},0).wait(1).to({scaleX:1.234,scaleY:1.234,x:195.45,y:227.45,startPosition:21},0).wait(1).to({scaleX:1.2969,scaleY:1.2969,x:200.85,y:225.05,startPosition:22},0).wait(1).to({scaleX:1.3715,scaleY:1.3715,x:207.25,y:222.25,startPosition:23},0).wait(1).to({scaleX:1.4626,scaleY:1.4626,x:215,y:218.8,startPosition:24},0).wait(1).to({scaleX:1.5785,scaleY:1.5785,x:224.9,y:214.4,startPosition:25},0).wait(1).to({scaleX:1.7372,scaleY:1.7372,x:238.5,y:208.35,startPosition:26},0).wait(1).to({regX:0,regY:393,scaleX:2,scaleY:2,x:240,y:176.2,startPosition:27},0).to({_off:true},1).wait(76));

	// chara_2
	this.instance_12 = new lib.chara_2_mc("synched",0,false);
	this.instance_12.parent = this;
	this.instance_12.setTransform(121.55,247.15,0.4,0.4,0,0,0,0,162);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(52).to({_off:false},0).wait(1).to({regX:-6,regY:192.3,scaleX:0.5256,scaleY:0.5256,x:108.9,y:254.2,startPosition:1},0).wait(1).to({scaleX:0.6212,scaleY:0.6212,x:101.1,y:250.45,startPosition:2},0).wait(1).to({scaleX:0.698,scaleY:0.698,x:94.9,y:247.4,startPosition:3},0).wait(1).to({scaleX:0.7619,scaleY:0.7619,x:89.7,y:244.8,startPosition:4},0).wait(1).to({scaleX:0.8165,scaleY:0.8165,x:85.25,y:242.65,startPosition:5},0).wait(1).to({scaleX:0.864,scaleY:0.864,x:81.4,y:240.75,startPosition:6},0).wait(1).to({scaleX:0.9062,scaleY:0.9062,x:77.95,y:239.05,startPosition:7},0).wait(1).to({scaleX:0.9444,scaleY:0.9444,x:74.9,y:237.55,startPosition:8},0).wait(1).to({scaleX:0.9795,scaleY:0.9795,x:72,y:236.15,startPosition:9},0).wait(1).to({scaleX:1.0125,scaleY:1.0125,x:69.3,y:234.85,startPosition:10},0).wait(1).to({scaleX:1.0442,scaleY:1.0442,x:66.75,y:233.6,startPosition:11},0).wait(1).to({scaleX:1.0753,scaleY:1.0753,x:64.2,y:232.35,startPosition:12},0).wait(1).to({scaleX:1.1064,scaleY:1.1064,x:61.7,y:231.1,startPosition:13},0).wait(1).to({scaleX:1.1382,scaleY:1.1382,x:59.1,y:229.85,startPosition:14},0).wait(1).to({scaleX:1.1717,scaleY:1.1717,x:56.35,y:228.5,startPosition:15},0).wait(1).to({scaleX:1.2076,scaleY:1.2076,x:53.45,y:227.1,startPosition:16},0).wait(1).to({scaleX:1.2471,scaleY:1.2471,x:50.25,y:225.55,startPosition:17},0).wait(1).to({scaleX:1.2916,scaleY:1.2916,x:46.65,y:223.75,startPosition:18},0).wait(1).to({scaleX:1.343,scaleY:1.343,x:42.45,y:221.75,startPosition:19},0).wait(1).to({scaleX:1.4041,scaleY:1.4041,x:37.5,y:219.3,startPosition:20},0).wait(1).to({scaleX:1.4794,scaleY:1.4794,x:31.35,y:216.3,startPosition:21},0).wait(1).to({scaleX:1.5776,scaleY:1.5776,x:23.4,y:212.35,startPosition:22},0).wait(1).to({scaleX:1.7188,scaleY:1.7188,x:11.9,y:206.8,startPosition:23},0).wait(1).to({regX:0.1,regY:162,scaleX:2,scaleY:2,x:1.15,y:134.95,startPosition:26},0).to({_off:true},1).wait(61));

	// chara_1
	this.instance_13 = new lib.chara_1_mc("synched",0,false);
	this.instance_13.parent = this;
	this.instance_13.setTransform(120,176,0.4,0.4,0,0,0,0,78.7);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(72).to({_off:false},0).wait(1).to({regX:6,regY:237.8,scaleX:0.491,scaleY:0.491,x:122.9,y:238.65,startPosition:1},0).wait(1).to({scaleX:0.5563,scaleY:0.5563,x:123.3,y:237.95,startPosition:2},0).wait(1).to({scaleX:0.6058,scaleY:0.6058,x:123.6,y:237.45,startPosition:3},0).wait(1).to({scaleX:0.6446,scaleY:0.6446,x:123.8,y:237.05,startPosition:4},0).wait(1).to({scaleX:0.6761,scaleY:0.6761,x:124,y:236.7,startPosition:5},0).wait(1).to({scaleX:0.7025,scaleY:0.7025,x:124.15,y:236.4,startPosition:6},0).wait(1).to({scaleX:0.7253,scaleY:0.7253,x:124.3,y:236.15,startPosition:7},0).wait(1).to({scaleX:0.7457,scaleY:0.7457,x:124.4,y:235.95,startPosition:8},0).wait(1).to({scaleX:0.7646,scaleY:0.7646,x:124.55,y:235.8,startPosition:9},0).wait(1).to({scaleX:0.7829,scaleY:0.7829,x:124.6,y:235.6,startPosition:10},0).wait(1).to({scaleX:0.8013,scaleY:0.8013,x:124.7,y:235.4,startPosition:11},0).wait(1).to({scaleX:0.8203,scaleY:0.8203,x:124.8,y:235.2,startPosition:12},0).wait(1).to({scaleX:0.8406,scaleY:0.8406,x:124.95,y:235,startPosition:13},0).wait(1).to({scaleX:0.8626,scaleY:0.8626,x:125.1,y:234.75,startPosition:14},0).wait(1).to({scaleX:0.8869,scaleY:0.8869,x:125.2,y:234.5,startPosition:15},0).wait(1).to({scaleX:0.9141,scaleY:0.9141,x:125.4,y:234.2,startPosition:16},0).wait(1).to({scaleX:0.9447,scaleY:0.9447,x:125.55,y:233.9,startPosition:17},0).wait(1).to({scaleX:0.9793,scaleY:0.9793,x:125.8,y:233.55,startPosition:18},0).wait(1).to({scaleX:1.0186,scaleY:1.0186,x:126,y:233.15,startPosition:19},0).wait(1).to({scaleX:1.0632,scaleY:1.0632,x:126.3,y:232.7,startPosition:20},0).wait(1).to({scaleX:1.114,scaleY:1.114,x:126.6,y:232.2,startPosition:21},0).wait(1).to({scaleX:1.1718,scaleY:1.1718,x:126.9,y:231.55,startPosition:22},0).wait(1).to({scaleX:1.2379,scaleY:1.2379,x:127.3,y:230.9,startPosition:23},0).wait(1).to({scaleX:1.3135,scaleY:1.3135,x:127.75,y:230.1,startPosition:24},0).wait(1).to({scaleX:1.4002,scaleY:1.4002,x:128.25,y:229.2,startPosition:25},0).wait(1).to({regX:0,regY:78.6,scaleX:1.5,scaleY:1.5,x:119.85,y:-10.6,startPosition:27},0).to({_off:true},1).wait(39));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(31).to({_off:false},0).wait(1).to({startPosition:0},0).wait(1).to({regY:155,scaleX:1.0778,scaleY:1.0778,x:120.05,y:153.35},0).wait(1).to({scaleX:1.086,scaleY:1.086,x:120,y:152.5},0).wait(1).to({scaleX:1.0945,scaleY:1.0945,x:120.05,y:151.7},0).wait(1).to({scaleX:1.1035,scaleY:1.1035,x:120,y:150.75},0).wait(1).to({scaleX:1.1129,scaleY:1.1129,x:120.05,y:149.8},0).wait(1).to({scaleX:1.1227,scaleY:1.1227,x:120,y:148.8},0).wait(1).to({scaleX:1.1329,scaleY:1.1329,x:120.05,y:147.8},0).wait(1).to({scaleX:1.1436,scaleY:1.1436,y:146.7},0).wait(1).to({scaleX:1.1547,scaleY:1.1547,y:145.6},0).wait(1).to({scaleX:1.1663,scaleY:1.1663,y:144.4},0).wait(1).to({scaleX:1.1783,scaleY:1.1783,y:143.2},0).wait(1).to({scaleX:1.1908,scaleY:1.1908,y:141.95},0).wait(1).to({scaleX:1.2039,scaleY:1.2039,y:140.6},0).wait(1).to({scaleX:1.2174,scaleY:1.2174,x:120.1,y:139.2},0).wait(1).to({scaleX:1.2315,scaleY:1.2315,x:120.05,y:137.75},0).wait(1).to({scaleX:1.2461,scaleY:1.2461,x:120.1,y:136.3},0).wait(1).to({scaleX:1.2612,scaleY:1.2612,y:134.8},0).wait(1).to({scaleX:1.2769,scaleY:1.2769,y:133.15},0).wait(1).to({scaleX:1.2932,scaleY:1.2932,y:131.5},0).wait(1).to({scaleX:1.3101,scaleY:1.3101,y:129.8},0).wait(1).to({scaleX:1.3276,scaleY:1.3276,y:128.05},0).wait(1).to({scaleX:1.3458,scaleY:1.3458,x:120.15,y:126.2},0).wait(1).to({scaleX:1.3646,scaleY:1.3646,y:124.25},0).wait(1).to({scaleX:1.3841,scaleY:1.3841,y:122.3},0).wait(1).to({scaleX:1.4044,scaleY:1.4044,y:120.25},0).wait(1).to({scaleX:1.4253,scaleY:1.4253,y:118.1},0).wait(1).to({scaleX:1.447,scaleY:1.447,x:120.2,y:115.9},0).wait(1).to({scaleX:1.4695,scaleY:1.4695,y:113.6},0).wait(1).to({scaleX:1.4928,scaleY:1.4928,y:111.3},0).wait(1).to({scaleX:1.517,scaleY:1.517,y:108.85},0).wait(1).to({scaleX:1.542,scaleY:1.542,y:106.25},0).wait(1).to({scaleX:1.568,scaleY:1.568,y:103.65},0).wait(1).to({scaleX:1.5949,scaleY:1.5949,x:120.25,y:100.9},0).wait(1).to({scaleX:1.6228,scaleY:1.6228,y:98.1},0).wait(1).to({scaleX:1.6517,scaleY:1.6517,y:95.1},0).wait(1).to({scaleX:1.6818,scaleY:1.6818,y:92.1},0).wait(1).to({scaleX:1.713,scaleY:1.713,y:88.9},0).wait(1).to({scaleX:1.7453,scaleY:1.7453,x:120.3,y:85.6},0).wait(1).to({scaleX:1.7789,scaleY:1.7789,y:82.25},0).wait(1).to({scaleX:1.8139,scaleY:1.8139,y:78.7},0).wait(1).to({scaleX:1.8502,scaleY:1.8502,x:120.35,y:75},0).wait(1).to({scaleX:1.8881,scaleY:1.8881,y:71.15},0).wait(1).to({scaleX:1.9274,scaleY:1.9274,y:67.15},0).wait(1).to({scaleX:1.9685,scaleY:1.9685,y:63},0).wait(1).to({scaleX:2.0113,scaleY:2.0113,x:120.4,y:58.65},0).wait(1).to({scaleX:2.056,scaleY:2.056,y:54.1},0).wait(1).to({scaleX:2.1027,scaleY:2.1027,y:49.4},0).wait(1).to({scaleX:2.1515,scaleY:2.1515,x:120.45,y:44.45},0).wait(1).to({scaleX:2.2027,scaleY:2.2027,x:120.5,y:39.2},0).wait(1).to({scaleX:2.2565,scaleY:2.2565,x:120.45,y:33.8},0).wait(1).to({scaleX:2.3129,scaleY:2.3129,x:120.5,y:28.05},0).wait(1).to({scaleX:2.3724,scaleY:2.3724,x:120.55,y:22.05},0).wait(1).to({scaleX:2.4352,scaleY:2.4352,y:15.65},0).wait(1).to({scaleX:2.5016,scaleY:2.5016,x:120.6,y:8.9},0).wait(1).to({scaleX:2.5722,scaleY:2.5722,y:1.75},0).wait(1).to({scaleX:2.6473,scaleY:2.6473,y:-5.9},0).wait(1).to({scaleX:2.7275,scaleY:2.7275,x:120.65,y:-14.05},0).wait(1).to({scaleX:2.8138,scaleY:2.8138,x:120.7,y:-22.75},0).wait(1).to({scaleX:2.907,scaleY:2.907,x:120.75,y:-32.2},0).wait(1).to({scaleX:3.0085,scaleY:3.0085,y:-42.55},0).wait(1).to({scaleX:3.12,scaleY:3.12,x:120.85,y:-53.85},0).wait(1).to({scaleX:3.244,scaleY:3.244,x:120.9,y:-66.4},0).wait(1).to({scaleX:3.3844,scaleY:3.3844,y:-80.7},0).wait(1).to({scaleX:3.5471,scaleY:3.5471,x:121,y:-97.15},0).wait(1).to({scaleX:3.7435,scaleY:3.7435,x:121.05,y:-117.1},0).wait(1).to({regY:167.1,scaleX:4,scaleY:4,x:121.15,y:-94.75},0).to({_off:true},1).wait(39));

	// bg_dark
	this.instance_15 = new lib.black();
	this.instance_15.parent = this;
	this.instance_15.setTransform(120,160,1,1,0,0,0,120,160);
	this.instance_15.alpha = 0.6992;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(1).to({_off:false},0).to({_off:true},35).wait(102));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(1).to({_off:false},0).to({_off:true},35).wait(102));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn).wait(138));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-238.8,-603.1,840,1183.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg8.jpg", id:"vote_group_shot_3_bg8"},
		{src:"images/bg9.jpg", id:"vote_group_shot_3_bg9"},
		{src:"images/ch1.png", id:"vote_group_shot_3_ch1"},
		{src:"images/ch1_w.png", id:"vote_group_shot_3_ch1_w"},
		{src:"images/ch2.png", id:"vote_group_shot_3_ch2"},
		{src:"images/ch2_w.png", id:"vote_group_shot_3_ch2_w"},
		{src:"images/ch3.png", id:"vote_group_shot_3_ch3"},
		{src:"images/ch3_w.png", id:"vote_group_shot_3_ch3_w"},
		{src:"images/ch_all.jpg", id:"vote_group_shot_3_ch_all"},
		{src:"images/ch_all_blur.jpg", id:"vote_group_shot_3_ch_all_blur"},
		{src:"images/font2_.png", id:"vote_group_shot_3_font2_"},
		{src:"images/font2_w.png", id:"vote_group_shot_3_font2_w"},
		{src:"images/fp_kira.png", id:"vote_group_shot_3_fp_kira"},
		{src:"images/logo_voice.png", id:"vote_group_shot_3_logo_voice"},
		{src:"images/logo_white.png", id:"vote_group_shot_3_logo_white"}
	],
	preloads: []
};
...
an.compositions['vote_group_shot_3'] = {
